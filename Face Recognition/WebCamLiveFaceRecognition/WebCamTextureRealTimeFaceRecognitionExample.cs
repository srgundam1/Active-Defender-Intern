...
namespace RealTimeFaceRecognitionExample
{
    ...
    public class WebCamTextureRealTimeFaceRecognitionExample : MonoBehaviour
    {
        ...
        */
        ...
        //public void takeRollClick()
        //{
        //    Popup popup = UIController.Instance.CreatePopup();
        //    string holder = "Shreya is present: " + firstPresent.ToString() + "Shreya2 is present".ToString();
        //    popup.Init(UIController.Instance.MainCanvas, holder);
        //}
    }
